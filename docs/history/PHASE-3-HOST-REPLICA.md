# Historical Phase 3 Host-Replica Plan

> Superseded by the userland-authority pivot. This file is retained only as a record of the abandoned host-replica design; it is not an active specification.
